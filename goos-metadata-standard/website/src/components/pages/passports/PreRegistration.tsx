    ...
    <Box sx={{ fontFamily: 'Montserrat, sans-serif', padding: 4, maxWidth: 1200, margin: '0 auto' }}>
      ...
      <Box sx={{ mb: 6 }}>
        ...
        <Typography variant="body1" sx={{ color: darkMode ? "#e0e0e0" : "#333", textAlign: 'center', mb: 2 }}>
          ...
          And equally important, the <strong>internalId</strong> field is particularly useful for users/networks to match their existing internal unique ID of their record (if they have one) with the WIGOS ID and temporary GOOS-WIGOS Passport that will be generated by the request.
        </Typography>
      </Box>
